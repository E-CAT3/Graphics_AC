Shader "Unlit/Specular"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // fixed4 CalcPhone(float2 uv, float3 refVec, float3 toEye, fixed3 lightCol);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 specularColor = CalcPhone(lightDir, i.normal, i.uv, i.worldPos, lightCol);
                fixed4 diffuseColor = CalcDiffuse(lightDir, i.normal, lightCol);
